...
contract Heisenberg is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 12000000 * 10 ** uint256(_decimals);
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private constant _name = 'HEISENBERG FINANCE';
    string private constant _symbol = 'HEISENBERG';
    
    uint256 private _taxFee = 200;
    uint256 private _burnFee = 200;
    uint private _max_tx_size = 120000 * 10 ** uint256(_decimals);
